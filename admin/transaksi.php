                             ...
                             <?php while ($transaksi = mysqli_fetch_array($data)) : ?>
                                 <tbody>
                                     <tr scope="row">
                                         ...
                                         <td>
                                             <p class="text-xs font-weight-bold mb-0">INI PHP $transaksi["id_transaksi"]; ?></p>

                                         </td>
                                         <td class="align-middle text-center text-sm">
                                             <span class="badge badge-sm bg-gradient-success">INI PHP $transaksi["tanggal_transaksi"]; ?></span>
                                         </td>
                                         <td class="align-middle text-center">
                                             <span class="text-secondary text-xs font-weight-bold">INI PHP $transaksi["nama_pembeli"]; ?></span>
                                         </td>
                                         <td class="align-middle text-center">
                                             <span class="text-secondary text-xs font-weight-bold">RP.INI PHP $transaksi["sub_total"]; ?></span>
                                         </td>

                                         <td class="align-middle text-center">
                                             <span class="text-secondary text-xs font-weight-bold">RP.INI PHP $transaksi["uang_kembalian"]; ?></span>
                                         </td>
                                         <td class="align-middle text-center">
                                             <span class="text-secondary text-xs font-weight-bold">INI PHP $transaksi["jenis_pembayaran"]; ?></span>
                                         </td>


                                         <td class="align-middle text-center">
                                             <span class="text-secondary text-xs font-weight-bold">INI PHP $transaksi["Keterangan"]; ?></span>
                                         </td>


                                         <td class="align-middle">

                                             <button type="button" class="btn " onclick="window.open('kwitansi.php?trans=INI PHP $transaksi['id_transaksi'] ?>','name','width=1000px,height=1000px')">
                                             ...
                                             <a href="../del/deltrans.php?kt=INI PHP $transaksi['id_transaksi'] ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="hapus">
